...
using IndependentComponentAnalysis: evaluate
using Test
using LinearAlgebra
using Test
...
@testset "IndependentComponentAnalysis.jl" begin
    ...
    @testset "ICA" begin
        ...
        @testset "Algorithm" begin
            ...
            @test_nowarn fit(ICA, X, k; do_whiten=true, tol=0.01)
            @test_throws StatsBase.ConvergenceException fit(ICA, X, k, fun=Gaus(); do_whiten=true, tol=0.01)
